...
const AddNewPopup = (props) => {
  ...
  const { fromBranch, toBranch, items, placedDate, status, deliveryDate } = props.delivery;
        ...
        body={
          <form onSubmit={onSubmit}>
            ...
            <div className="form-group">
              ...
              <select id="status" name="status" className="form-control" value={status} onChange={(e) => onChange(e.target.name, e.target.value)}>
